...
type Page = 'landing' | 'predict' | 'skin' | 'reports' | 'about';
...
export function LandingPage({ onNavigate }: LandingPageProps) {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Upload skin images for instant AI diagnosis of various skin conditions and disorders',
      action: () => onNavigate('skin'),
      badge: 'Image Based'
    },
    {
      icon: FileText,
            ...
            <motion.div className="space-y-8" variants={itemVariants}>
              <div className="space-y-4">
                ...
                <motion.p 
                  ...
                  variants={itemVariants}
                >
                  Get instant AI-powered health insights from medical data and skin images. 
